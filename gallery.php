...
<html>
<head>
<title>Eduma a Education Category Flat Bootstrap Responsive Website Template| Gallery :: w3layouts</title>
<!-- for-mobile-apps -->
    ...
    <div class="page-head">
			<div class="header-nav">
				<div class="logo wow fadeInUp animated" data-wow-delay=".5s">
					<h1>
						<a class="link link--kumya" href="index.php"><i></i><span data-letters="EDUMA">EDUMA</span></a>
					</h1>
				</div>
