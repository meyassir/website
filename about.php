...
<html class="no-js" lang="en">
    <head>
        ...
        <link rel="stylesheet" href="assets2/css/fonticons.css">
                ...
                <!-- End Top Search -->
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="index.php">
                            <img src="assets2/images/logo.png" class="logo logo-display" alt="">
                            <img src="assets2/images/logo-black.png" class="logo logo-scrolled" alt="">
                    ...
                    <div class="collapse navbar-collapse" id="navbar-menu">
                        <ul class="nav navbar-nav navbar-right" data-in="fadeInDown" data-out="fadeOutUp">
                            ...
                            <li><a href="model.php">our models</a></li> 							
                            <li><a href="blog.html">blog</a></li>                                    
                            <li><a href="contact.php">contact</a></li>
                            <li><a href="contact.php">forum</a></li>
                            <li><a href="contact.php">contact</a></li>  
                            <li><a href="contact.php">S'inscrire</a></li>        
                        </ul>
                    </div><!-- /.navbar-collapse -->
                </div>  
            </nav>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 col-sm-6">
                                            <div class="ab_feature_item sm-m-top-20">
                                                <img src="assets2/images/ab-f-img1.jpg" alt="" />
                                            </div>
                                        </div>
                                        <div class="col-md-4 col-sm-6">
                                            <div class="ab_feature_item sm-m-top-20">
                                                <img src="assets2/images/ab-f-img2.jpg" alt="" />
                                            </div>
                                        </div>
                                        <div class="col-md-4 col-sm-6">
                                            <div class="ab_feature_item sm-m-top-20">
                                                <img src="assets2/images/ab-f-img3.jpg" alt="" />
                                            </div>
                                        </div>
                                        <div class="col-md-4 col-sm-6">
                                            <div class="ab_feature_item m-top-20">
                                                <img src="assets2/images/ab-f-img4.jpg" alt="" />
                                            </div>
                                        </div>
                                        <div class="col-md-4 col-sm-6">
                                            <div class="ab_feature_item m-top-20">
                                                <img src="assets2/images/ab-f-img5.jpg" alt="" />
                                            </div>
                                        </div>
                                        <div class="col-md-4 col-sm-6">
                                            <div class="ab_feature_item m-top-20">
                                                <img src="assets2/images/ab-f-img6.jpg" alt="" />
                                            </div>
                                        </div>
                                        <div class="col-md-4 col-sm-6">
                                            <div class="ab_feature_item m-top-20">
                                        ...
                                        <div class="col-md-4 col-sm-6">
                                            <div class="ab_feature_item m-top-20">
                                                <img src="assets2/images/ab-f-img8.jpg" alt="" />
                                            </div>
                                        </div>
                                        <div class="col-md-4 col-sm-6">
                                            <div class="ab_feature_item m-top-20">
                                                <img src="assets2/images/ab-f-img9.jpg" alt="" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="main_teams">
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="team_item m-top-30">
                                    <div class="team_img">
                                        <img src="assets2/images/model-img1.jpg" alt="" />
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="team_item m-top-30">
                                    <div class="team_img">
                                        <img src="assets2/images/model-img2.jpg" alt="" />
                                        <div class="team_caption">
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="team_item m-top-30">
                                    <div class="team_img">
                                        <img src="assets2/images/model-img3.jpg" alt="" />
                                        <div class="team_caption">
                                    ...
                                    <div class="item active testimonial_item">
                                        <div class="col-sm-10 col-sm-offset-1">
                                            ...
                                            <div class="test_authour">
                                                <img class="img-circle" src="assets2/images/test-img.jpg" alt="" />
                        ...
                        <div class="main_cbrand text-center">
                            <div class="col-md-2 col-sm-4 col-xs-6">
                                <div class="cbrand_item m-bottom-10">
                                    <a href=""><img src="assets2/images/brand-img1.png" alt="" /></a>
                                </div>
                            </div>
                            <div class="col-md-2 col-sm-4 col-xs-6">
                                <div class="cbrand_item m-bottom-10">
                                    <a href=""><img src="assets2/images/brand-img2.png" alt="" /></a>
                                </div>
                            </div>
                            <div class="col-md-2 col-sm-4 col-xs-6">
                                <div class="cbrand_item m-bottom-10">
                                    <a href=""><img class="" src="assets2/images/brand-img3.png" alt="" /></a>
                                </div>
                            </div>
                            <div class="col-md-2 col-sm-4 col-xs-6">
                                <div class="cbrand_item m-bottom-10">
                                    <a href=""><img src="assets2/images/brand-img4.png" alt="" /></a>
                                </div>
                            </div>
                            <div class="col-md-2 col-sm-4 col-xs-6">
                                <div class="cbrand_item m-bottom-10">
                                    <a href=""><img src="assets2/images/brand-img5.png" alt="" /></a>
                                </div>
                            </div>
                            <div class="col-md-2 col-sm-4 col-xs-6">
                                <div class="cbrand_item m-bottom-10">
...
<div class="footer">
	<div class="container">
		...
		<div class="copy-right">
			<p>2017 BILAL IBN RABAH .&copy; All Rights Reserved | Designed by  <a href="https://www.facebook.com/profile.php?id=100009886295342">YOUSSEF IFKERNE</a></p>
		</div>
	</div>
</div>
<!-- //footer-->
...
<script src="assets2/js/vendor/jquery-1.11.2.min.js"></script>
        ...
        <script src="assets2/js/jquery.collapse.js"></script>
